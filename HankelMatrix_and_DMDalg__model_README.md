...
*Instead of using LSTM neural nets, which seem to be one of the most common approaches*, in this repo we see the time data points as snapshots of an underlying
